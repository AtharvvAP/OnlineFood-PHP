    ...
    if(empty($_POST['d_name']) || empty($_POST['about']) || empty($_POST['price']) || empty($_POST['res_name'])) {
        ...
        if($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id,title,slogan,price,discount,img) VALUES('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$discount."','".$fnew."')";
                mysqli_query($db, $sql);
    ...
    <main class="admin-content">
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <h2 class="admin-card-title">Add New Menu Item</h2>
            </div>
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="d_name" class="form-input" placeholder="Enter dish name" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Description</label>
                            <input type="text" name="about" class="form-input" placeholder="Short description" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="discount" class="form-input" placeholder="0" min="0" max="100" step="0.01" value="0">
                            <small style="color: #718096; font-size: 0.875rem;">Optional: Enter discount percentage (0-100)</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small style="color: #718096; font-size: 0.875rem;">Max size: 1MB (JPG, PNG, GIF)</small>
                        </div>
                    </div>
